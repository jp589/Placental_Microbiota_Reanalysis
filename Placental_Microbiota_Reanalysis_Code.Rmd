...
set.seed(1); adonis_pw_V4P_del <- pairwise.adonis(x = t(V4_ASV_P), factors = V4_META_P$Delivery)
```
...
set.seed(1); adonis_Parnell_Lvl <- pairwise.adonis(x = t(Parnell_rare_ASV), factors = Parnell_rare_META$Level, perm = 999)
...
#returns NPMANOVA statistics of placental samples by level compared to technical controls for Parnell study
set.seed(1); adonis_Sterpu_Lvl <- pairwise.adonis(x = t(Sterpu_rare_ASV), factors =  Sterpu_rare_META$Level, perm = 999)
...
#returns NPMANOVA statistics of placental samples by level compared to technical controls for Parnell study
set.seed(1); adonis_Theis_Lvl <- pairwise.adonis(x = t(Theis_rare_ASV), factors =  Theis_rare_META$Level, perm = 999)
...
#returns NPMANOVA statistics of placental samples by level compared to technical controls for Parnell study
set.seed(1); adonis_Theis_Winters_Lvl <- pairwise.adonis(x = t(Theis_Winters_ASV_PTC), factors =  Theis_Winters_META_PTC$Level, perm = 999)
```