...
#returns NPMANOVA statistics of placental samples by level compared to technical controls for Parnell study
set.seed(1); adonis_Theis_Winters_Lvl <- pairwise.adonis2(x = t(Theis_Winters_ASV_PTC) ~ Level, data = Theis_Winters_META_PTC)

#Table S3 Metadata
Table_S3_Meta <- data.frame(
  Study = c("de Goffau", rep("Parnell", 3), "Olomu", rep("Sterpu", 3), rep("Theis", 2), rep("Theis, Winters", 5)),
...
Table_S3_Results <- data.frame(
  Disp_F_Stat = c(
    disp_dg$`F value`[1], 
    disp_Parnell_FM$`F value`[1], 
    disp_Parnell_PV$`F value`[1], 
    disp_Parnell_BP$`F value`[1], 
    disp_Olomu$`F value`[1], 
    disp_Sterpu_fetal$`F value`[1], 
    disp_Sterpu_middle$`F value`[1], 
    disp_Sterpu_decidua$`F value`[1], 
    disp_Theis_ac$`F value`[1], 
    disp_Theis_vt$`F value`[1], 
    disp_Theis_Winters_a$`F value`[1], 
    disp_Theis_Winters_ac$`F value`[1], 
    disp_Theis_Winters_sub$`F value`[1], 
    disp_Theis_Winters_vt$`F value`[1], 
    disp_Theis_Winters_bp$`F value`[1]
    ), Disp_P_Val = c(
      disp_dg$`Pr(>F)`[1], 
      disp_Parnell_FM$`Pr(>F)`[1], 
      disp_Parnell_PV$`Pr(>F)`[1], 
      disp_Parnell_BP$`Pr(>F)`[1], 
      disp_Olomu$`Pr(>F)`[1], 
      disp_Sterpu_fetal$`Pr(>F)`[1], 
      disp_Sterpu_middle$`Pr(>F)`[1], 
      disp_Sterpu_decidua$`Pr(>F)`[1], 
      disp_Theis_ac$`Pr(>F)`[1], 
      disp_Theis_vt$`Pr(>F)`[1], 
      disp_Theis_Winters_a$`Pr(>F)`[1], 
      disp_Theis_Winters_ac$`Pr(>F)`[1], 
      disp_Theis_Winters_sub$`Pr(>F)`[1], 
      disp_Theis_Winters_vt$`Pr(>F)`[1], 
      disp_Theis_Winters_bp$`Pr(>F)`[1]
      ),  ADONIS_R2 = c(
        adonis_dg$aov.tab$R2[1], 
        adonis_Parnell_Lvl$`Fetal Membrane_vs_Technical Control`$R2[1], 
        adonis_Parnell_Lvl$`Placental Villus_vs_Technical Control`$R2[1], 
        adonis_Parnell_Lvl$`Basal Plate_vs_Technical Control`$R2[1], 
        adonis_Olomu$aov.tab$R2[1], 
        adonis_Sterpu_Lvl$`fetal_vs_Technical Control`$R2[1], 
        adonis_Sterpu_Lvl$`middle_vs_Technical Control`$R2[1], 
        adonis_Sterpu_Lvl$`decidua_vs_Technical Control`$R2[1], 
        adonis_Theis_Lvl$`Amnion-Chorion_vs_Technical Control`$R2[1], 
        adonis_Theis_Lvl$`Villous Tree_vs_Technical Control`$R2[1],
        adonis_Theis_Winters_Lvl$`Amnion_vs_Technical Control`$R2[1],
        adonis_Theis_Winters_Lvl$`Amnion-Chorion_Interface_vs_Technical Control`$R2[1],
        adonis_Theis_Winters_Lvl$`Subchorionic_Plate_Swab_vs_Technical Control`$R2[1],
        adonis_Theis_Winters_Lvl$`Villous_Tree_vs_Technical Control`$R2[1],
        adonis_Theis_Winters_Lvl$`Basal_Plate_vs_Technical Control`$R2[1]
        ),  ADONIS_F_Stat = c(
          adonis_dg$aov.tab$F.Model[1], 
          adonis_Parnell_Lvl$`Fetal Membrane_vs_Technical Control`$F[1], 
          adonis_Parnell_Lvl$`Placental Villus_vs_Technical Control`$F[1], 
          adonis_Parnell_Lvl$`Basal Plate_vs_Technical Control`$F[1], 
          adonis_Olomu$aov.tab$F.Model[1], 
          adonis_Sterpu_Lvl$`fetal_vs_Technical Control`$F[1], 
          adonis_Sterpu_Lvl$`middle_vs_Technical Control`$F[1], 
          adonis_Sterpu_Lvl$`decidua_vs_Technical Control`$F[1], 
          adonis_Theis_Lvl$`Amnion-Chorion_vs_Technical Control`$F[1], 
          adonis_Theis_Lvl$`Villous Tree_vs_Technical Control`$F[1],
          adonis_Theis_Winters_Lvl$`Amnion_vs_Technical Control`$F[1],
          adonis_Theis_Winters_Lvl$`Amnion-Chorion_Interface_vs_Technical Control`$F[1],
          adonis_Theis_Winters_Lvl$`Subchorionic_Plate_Swab_vs_Technical Control`$F[1],
          adonis_Theis_Winters_Lvl$`Villous_Tree_vs_Technical Control`$F[1],
          adonis_Theis_Winters_Lvl$`Basal_Plate_vs_Technical Control`$F[1]
          ), ADONIS_P_Val = c(
            adonis_dg$aov.tab$`Pr(>F)`[1], 
            adonis_Parnell_Lvl$`Fetal Membrane_vs_Technical Control`$`Pr(>F)`[1], 
            adonis_Parnell_Lvl$`Placental Villus_vs_Technical Control`$`Pr(>F)`[1], 
            adonis_Parnell_Lvl$`Basal Plate_vs_Technical Control`$`Pr(>F)`[1],
            adonis_Olomu$aov.tab$`Pr(>F)`[1], 
            adonis_Sterpu_Lvl$`fetal_vs_Technical Control`$`Pr(>F)`[1], 
            adonis_Sterpu_Lvl$`middle_vs_Technical Control`$`Pr(>F)`[1],
            adonis_Sterpu_Lvl$`decidua_vs_Technical Control`$`Pr(>F)`[1],
            adonis_Theis_Lvl$`Amnion-Chorion_vs_Technical Control`$`Pr(>F)`[1], 
            adonis_Theis_Lvl$`Villous Tree_vs_Technical Control`$`Pr(>F)`[1],
            adonis_Theis_Winters_Lvl$`Amnion_vs_Technical Control`$`Pr(>F)`[1],
            adonis_Theis_Winters_Lvl$`Amnion-Chorion_Interface_vs_Technical Control`$`Pr(>F)`[1],
            adonis_Theis_Winters_Lvl$`Subchorionic_Plate_Swab_vs_Technical Control`$`Pr(>F)`[1],
            adonis_Theis_Winters_Lvl$`Villous_Tree_vs_Technical Control`$`Pr(>F)`[1],
            adonis_Theis_Winters_Lvl$`Basal_Plate_vs_Technical Control`$`Pr(>F)`[1]
            ), stringsAsFactors = FALSE)
