...
#performs pairwise analysis of variance between sample types (gestational age) using ADONIS (NPMANOVA).
#all pairwise comparsions significantly different
set.seed(1); adonis_pw_V4P_ga <- pairwise.adonis2(x = t(V4_ASV_P) ~ GA, data = V4_META_P)
```
